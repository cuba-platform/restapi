...
import static com.haulmont.addon.restapi.api.auth.CubaTokenEnhancer.EXTENDED_DETAILS_ATTRIBUTE_PREFIX;
...
public class ExternalOAuthTokenGranter extends AbstractTokenGranter implements OAuthTokenIssuer {
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        String sessionId = tokenRequest.getRequestParameters().get(CubaUserAuthenticationProvider.SESSION_ID_DETAILS_ATTRIBUTE);
        ...
        details.put(CubaUserAuthenticationProvider.SESSION_ID_DETAILS_ATTRIBUTE, sessionId);
