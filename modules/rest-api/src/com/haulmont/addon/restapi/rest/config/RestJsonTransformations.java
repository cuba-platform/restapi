...
package com.haulmont.addon.restapi.rest.config;
...
import com.haulmont.addon.restapi.rest.transform.EntityJsonTransformer;
import com.haulmont.addon.restapi.rest.transform.JsonTransformationDirection;
import com.haulmont.addon.restapi.rest.transform.StandardEntityJsonTransformer;
...
public class RestJsonTransformations {
    ...
    protected static final String CUBA_REST_JSON_TRANSFORMATION_CONFIG_PROP_NAME = "cuba.rest.jsonTransformationConfig";
