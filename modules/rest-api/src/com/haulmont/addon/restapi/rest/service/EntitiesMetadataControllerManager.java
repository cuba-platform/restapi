...
import com.haulmont.addon.restapi.rest.controllers.EntitiesMetadataController;
import com.haulmont.addon.restapi.rest.exception.RestAPIException;
import com.haulmont.addon.restapi.rest.service.filter.data.MetaClassInfo;
...
/**
 * Class is used by the {@link EntitiesMetadataController}. Class is sed for getting
 * entities metadata. User permissions for entities access aren't taken into account at the moment.
 */
@Component("restapi_EntitiesMetadataControllerManager")
