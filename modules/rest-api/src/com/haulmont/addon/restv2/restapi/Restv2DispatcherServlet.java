...
public class Restv2DispatcherServlet extends DispatcherServlet {

    private static final Logger log = LoggerFactory.getLogger(Restv2DispatcherServlet.class);

    private static final long serialVersionUID = -4884517938479910144L;

    public static final String SPRING_CONTEXT_CONFIG = "cuba.restv2SpringContextConfig";
