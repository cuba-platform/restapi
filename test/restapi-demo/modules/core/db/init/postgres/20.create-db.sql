...
create index IDX_REF_ALLOCATED_CAR_ON_MODEL on REF_ALLOCATED_CAR (MODEL_ID)^
...
create unique index IDX_REF_DRIVER_CALLSIGN_UK_CALLSIGN on REF_DRIVER_CALLSIGN (CALLSIGN) where DELETE_TS is null ^
